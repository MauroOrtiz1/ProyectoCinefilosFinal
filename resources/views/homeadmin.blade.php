...
@section('content')
    <div class="container">
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://static.cinepolis.com/img/front/11/20231129165857889-prin.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://static.cinepolis.com/img/front/11/20231122992386-prin.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://static.cinepolis.com/img/front/11/202311884127940-prin.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
      ...
      <div class="text-end">
        <a href="{{ route('enviarAPI') }}" class="btn btn-outline-success btn-lg">Ver resultados</a>
      </div>
